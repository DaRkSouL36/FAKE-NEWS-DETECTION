...
def load_model_and_vectorizer():
    try:
        ...
        logger.info("MODEL AND VECTORIZER LOADED SUCCESSFULLY.")  # LOGGING A SUCCESS MESSAGE IF LOADING IS SUCCESSFUL
        ...
        logger.error(f"ERROR LOADING MODEL/VECTORIZER: {e}")      # LOGGING AN ERROR MESSAGE WITH THE EXCEPTION DETAILS
